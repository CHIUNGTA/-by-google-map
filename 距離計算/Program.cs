            ...
            try
            {
                    ...
                    var file = new System.IO.StreamReader(add);
                {
                    ...
                    while ((Line =file.ReadLine()) != null)
                    {
                        ...
                        string APIUrl = string.Format($"https://maps.googleapis.com/maps/api/distancematrix/json?units=imperial&origins={ReadLine_Array[1]+","+ ReadLine_Array[2]}&destinations={ReadLine_Array[3] + "," + ReadLine_Array[4]}&language=zh-tw&key=Your___key");
